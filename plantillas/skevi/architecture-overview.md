...
<lista de enlaces, p. ej.:>
- `docs/adr/ADR-001-<titulo>.md` — <una línea: qué decide>
- `docs/adr/ADR-002-<titulo>.md` — <una línea: qué decide>

<o, si no hay ninguno todavía:>
Pendiente. F1 (specs/ADR/contratos) no se ha cerrado para este proyecto —
ver `docs/guia-agentes-ia/02-specs-adr-contratos.md`.
